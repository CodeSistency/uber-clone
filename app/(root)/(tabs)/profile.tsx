...
const Profile = () => {
    ...
    return (
      <SafeAreaView className="flex-1 bg-white">
        <View className="flex-1 items-center justify-center">
          ...
          <Text className="mt-4 text-lg font-JakartaMedium text-gray-600">
            Loading profile...
          </Text>
  ...
  if (!user) {
    return (
      <SafeAreaView className="flex-1 bg-white">
        <View className="flex-1 items-center justify-center px-5">
          <View className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
            <Text className="text-xl font-JakartaBold text-yellow-800 mb-2">
              ⚠️ Profile Data Unavailable
            </Text>
            <Text className="text-center text-yellow-700 font-JakartaMedium mb-4">
          ...
          <Text className="text-center text-gray-500 font-JakartaRegular mt-4 text-sm">
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        <View className="flex items-center justify-center my-5">
          ...
          <Text className="mt-4 text-xl font-JakartaBold text-gray-800">
            {user.name || "User"}
          </Text>
          <Text className="mt-1 text-sm font-JakartaMedium text-gray-500">
            Active Member
          </Text>
        </View>

        <View className="flex flex-col items-start justify-center bg-white rounded-lg shadow-lg shadow-neutral-300 px-5 py-4 border border-gray-100">
          <Text className="text-lg font-JakartaBold text-gray-800 mb-4 w-full">
            Account Information
          </Text>
