      ...
      <ScrollView className="flex-1 px-5">
        ...
        <View className="bg-white rounded-lg p-4 mb-4">
          <View className="flex-row justify-between items-center mb-3">
            <Text className="text-lg font-JakartaBold">Your Emergency Contacts</Text>
            <TouchableOpacity
          ...
          {contacts.length === 0 && !showAddForm ? (
            <View className="py-8 items-center">
              ...
              >
                <Text className="text-white font-JakartaBold">Add First Contact</Text>
              </TouchableOpacity>
            </View>
          ) : (
            contacts.map((contact) => (
              <View key={contact.id} className="flex-row items-center py-3 border-b border-general-500 last:border-b-0">
                <View className="flex-1">
                  <Text className="font-JakartaBold text-lg">{contact.name}</Text>
                  <Text className="text-secondary-600">{contact.phone}</Text>
                  <Text className="text-secondary-600 text-sm">{contact.relationship}</Text>
                </View>
        ...
        {showAddForm && (
          <View className="bg-white rounded-lg p-4 mb-6">
            <Text className="text-lg font-JakartaBold mb-3">Add Emergency Contact</Text>
            ...
            <View className="space-y-3">
              ...
              >
                <Text className="text-white font-JakartaBold text-center">Add Contact</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
        ...
        <View className="bg-white rounded-lg p-4 mb-8">
          ...
          <View className="space-y-3">
            ...
            <View className="flex-row items-start">
              <Text className="text-primary-500 mr-3 mt-1">•</Text>
              <Text className="text-secondary-600 flex-1">
                Emergency contacts will receive your trip details and live location
              </Text>
            </View>
          </View>
        </View>
        ...
        <View className="bg-warning-50 border border-warning-200 rounded-lg p-4 mb-8">
          <View className="flex-row items-center mb-2">
            ...
            <Text className="font-JakartaBold text-warning-700">Emergency Information</Text>
          </View>
          <Text className="text-warning-700 text-sm">
            In case of emergency, your location, trip details, and contact information will be shared with your emergency contacts. This feature is designed to keep you safe during your trips.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
