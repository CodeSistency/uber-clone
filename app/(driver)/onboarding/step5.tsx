...
const OnboardingStep5 = () => {
  ...
  const validateAgreements = () => {
    ...
    for (const agreement of requiredAgreements) {
      if (!agreements[agreement]) {
        showError(
          "Required Agreement",
          `Please accept the ${getAgreementName(agreement)}`,
        );
        return false;
      }
    }
  ...
  const showAgreementModal = (type: "terms" | "privacy" | "safety") => {
    ...
    Alert.alert(getAgreementTitle(type), content, [
          ...
          <Card className="mb-6">
            ...
            <View className="space-y-4">
              ...
              <View className="flex-row items-start">
                ...
                <View className="flex-1 ml-3">
                  <TouchableOpacity
                    onPress={() => showAgreementModal("privacy")}
                  >
                    <Text className="text-secondary-700 font-JakartaMedium">
                      I agree to the{" "}
                      <Text className="text-primary-600 underline">
              ...
              <View className="flex-row items-start">
                <Checkbox
                  ...
                  onChange={(checked) =>
                    updateAgreement("safetyAccepted", checked)
                  }
                  className="mt-1"
                />
                <View className="flex-1 ml-3">
                  <TouchableOpacity
                    onPress={() => showAgreementModal("safety")}
                  >
                    <Text className="text-secondary-700 font-JakartaMedium">
                      I agree to the{" "}
                      <Text className="text-primary-600 underline">
              ...
              <View className="flex-row items-start">
                <Checkbox
                  ...
                  onChange={(checked) =>
                    updateAgreement("backgroundCheckConsent", checked)
                  }
                  className="mt-1"
                />
                <View className="flex-1 ml-3">
            ...
            <View className="space-y-4">
              ...
              <View className="flex-row items-start">
                ...
                <View className="flex-1 ml-3">
                  ...
                  <Text className="text-secondary-500 text-sm mt-1">
                    Special offers, updates, and driver opportunities via email
                    and SMS
                  </Text>
                </View>
              </View>
              ...
              <View className="flex-row items-start">
                <Checkbox
                  ...
                  onChange={(checked) =>
                    updateAgreement("dataSharingConsent", checked)
                  }
                  className="mt-1"
                />
                <View className="flex-1 ml-3">
                  <Text className="text-secondary-700 font-JakartaMedium">
                    I agree to share anonymous driving data for research and
                    improvements
                  </Text>
                  <Text className="text-secondary-500 text-sm mt-1">
                    Help improve our platform by sharing anonymized trip data
                    and feedback
                  </Text>
                </View>
              </View>
            ...
            <View className="space-y-4">
              <View className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <Text className="text-blue-700 text-sm">
                  ...
                  You'll receive an email notification once approved to start
                  driving.
                </Text>
              </View>
              ...
              <View className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <Text className="text-yellow-700 text-sm">
                  As a driver, you're considered an independent contractor. You
                  must comply with all local laws, maintain current insurance,
              ...
              <View className="bg-red-50 border border-red-200 rounded-lg p-4">
                ...
                <Text className="text-red-700 text-sm">
                  ...
                  terms, safety issues, passenger complaints, or fraudulent
                  activity.
                </Text>
              </View>
            </View>
