...
export const FLOW_STEPS = {
  ...
  CUSTOMER_TRANSPORT_ELECCION_CONDUCTOR: 'CUSTOMER_TRANSPORT_ELECCION_CONDUCTOR',
...
export const AVAILABLE_SERVICES = [
  ...
  },
  {
    ...
    icon: '📦',
    description: 'Envíos seguros de paquetes'
  }
];
...
export const SERVICE_FLOWS = {
  ...
  customer: {
    [SERVICES.TRANSPORT]: [
      ...
      FLOW_STEPS.CUSTOMER_TRANSPORT_ELECCION_CONDUCTOR,
