...
export const useEarningsStore = create<EarningsStore>((set, get) => ({
  ...
  fetchDailyEarnings: async (date: string) => {
    ...
    try {
      ...
      state.setError((error as Error).message || 'Failed to fetch daily earnings');
    } finally {
  ...
  fetchWeeklyEarnings: async (weekStart: string) => {
    ...
    try {
      ...
      state.setError((error as Error).message || 'Failed to fetch weekly earnings');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  fetchMonthlyEarnings: async (month: string, year: number) => {
    ...
    try {
      ...
      state.setError((error as Error).message || 'Failed to fetch monthly earnings');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  fetchRideDetails: async (date: string) => {
    ...
    try {
      ...
      state.setError((error as Error).message || 'Failed to fetch ride details');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  fetchTransactionHistory: async (limit = 50) => {
    ...
    try {
      ...
      console.error('[EarningsStore] Error fetching transaction history:', error);
      state.setError((error as Error).message || 'Failed to fetch transaction history');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  fetchHourlyEarnings: async (date: string) => {
    ...
    try {
      ...
      // TODO: Replace with actual API call
      const mockHourlyEarnings: HourlyEarnings[] = Array.from({ length: 24 }, (_, hour) => ({
        hour,
      ...
      state.setError((error as Error).message || 'Failed to fetch hourly earnings');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  fetchActivePromotions: async () => {
    ...
    try {
      ...
      state.setError((error as Error).message || 'Failed to fetch active promotions');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  fetchCompletedChallenges: async () => {
    ...
    try {
      ...
      console.error('[EarningsStore] Error fetching completed challenges:', error);
      state.setError((error as Error).message || 'Failed to fetch completed challenges');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  fetchPaymentMethods: async () => {
    ...
    try {
      ...
      state.setError((error as Error).message || 'Failed to fetch payment methods');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  requestInstantPay: async (request: InstantPayRequest) => {
    ...
    try {
      ...
      state.setError((error as Error).message || 'Failed to request instant pay');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  checkInstantPayAvailability: async () => {
    ...
    try {
      ...
      console.error('[EarningsStore] Error checking instant pay availability:', error);
      state.setError((error as Error).message || 'Failed to check instant pay availability');
    } finally {
      state.setLoading(false);
    }
  },
  ...
  joinChallenge: async (challengeId: string) => {
    ...
    try {
      ...
      console.log('[EarningsStore] Successfully joined challenge:', challengeId);
    } catch (error) {
  ...
  claimPromotion: async (promotionId: string) => {
    ...
    try {
      ...
      console.log('[EarningsStore] Successfully claimed promotion:', promotionId);
    } catch (error) {
