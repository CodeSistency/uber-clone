...
describe("Authentication Functions", () => {
  ...
  describe("Token Validation", () => {
    test("isTokenExpired returns true for expired token", () => {
      const expiredToken =
        "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MDAwMDAwMDB9.abc"; // exp: 1600000000 (Sept 2020)
  ...
  describe("Session Management", () => {
    ...
    test("updateActivity resets last activity time", () => {
      ...
      expect(sessionInfo.lastActivity.getTime()).toBeGreaterThan(
        oldTime.getTime(),
      );
    });
