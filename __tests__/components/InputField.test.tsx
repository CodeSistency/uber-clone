...
describe('InputField', () => {
  ...
  describe('Styling and Customization', () => {
    ...
    test('applies custom icon style', () => {
      const mockIcon = () => <span>📧</span>;
      const { getByPlaceholderText } = render(
        <InputField {...defaultProps} icon={mockIcon} iconStyle="custom-icon" />
      );
  ...
  describe('Performance', () => {
    test('is memoized to prevent unnecessary re-renders', () => {
      ...
      const { rerender } = render(
        <InputField label="Test" placeholder="Test" onChangeText={onChangeText} />
      );

      // Re-render with same props should not cause issues
      rerender(<InputField label="Test" placeholder="Test" onChangeText={onChangeText} />);
