    ...
    <View className="flex-row justify-center p-3 bg-brand-primary dark:bg-brand-primaryDark border-b border-secondary-300 dark:border-secondary-600">
      {modules.map((module) => {
        ...
        return (
          ...
          >
            <Text className={`text-xs mb-1 ${isActive ? 'text-brand-primary' : 'text-secondary-600 dark:text-secondary-300'}`}>
              {module.icon}
            </Text>
            <Text className={`text-xs font-JakartaMedium ${
              isActive ? 'text-brand-primary' : 'text-secondary-600 dark:text-secondary-300'
            }`}>
              {module.shortLabel}
            </Text>
          </TouchableOpacity>
