    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <ScrollView className="flex-1 p-4">
        ...
        <View className="bg-white p-4 rounded-lg mb-4 shadow-sm">
          ...
          <Text className="text-gray-600">• Module: {drawer.currentModule}</Text>
          <Text className="text-gray-600">• Active Route: {drawer.activeRoute || 'None'}</Text>
          <Text className="text-gray-600">• Drawer: {drawer.isOpen ? 'Open' : 'Closed'}</Text>
        </View>

        {/* Acciones rápidas */}
        <View className="flex-row justify-between mb-6">
          <TouchableOpacity className="bg-blue-500 px-4 py-3 rounded-lg flex-1 mr-2">
            <Text className="text-white font-JakartaMedium text-center">Find Ride</Text>
          </TouchableOpacity>

          <TouchableOpacity className="bg-green-500 px-4 py-3 rounded-lg flex-1 ml-2">
            <Text className="text-white font-JakartaMedium text-center">Order Food</Text>
          </TouchableOpacity>
        </View>
        ...
        <View className="bg-white p-4 rounded-lg shadow-sm">
          ...
          <View className="flex-row justify-between">
            <TouchableOpacity
              ...
              disabled={drawer.currentModule === 'customer' || drawer.isTransitioning}
            ...
            <TouchableOpacity
              ...
              disabled={drawer.currentModule === 'business' || drawer.isTransitioning}
            ...
            <TouchableOpacity
              ...
              disabled={drawer.currentModule === 'driver' || drawer.isTransitioning}
