...
const ConfirmOrigin: React.FC = () => {
  ...
  return (
    <View>
      <Text className="font-JakartaBold text-lg mb-2">Confirma tu punto de partida</Text>
      <Text className="text-secondary-700 mb-3">Mueve el mapa para posicionar el pin y presiona confirmar.</Text>
      <View className="flex-row">
        ...
        <TouchableOpacity onPress={() => {
          ...
          <Text className="text-black font-JakartaBold text-center">Confirmar origen</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
